...
/**
 * Write a description of class VIPCustomerReview here.
 *
 * @author  Conrad Hahn
 * @version 2/18/2025
 */
public class VIPCustomerReview
{
    ...
    /**
     * Constructor for objects of class VIPCustomerReview
     */
    ...
    public boolean equals(Object customerNameCheck){
        if(customerNameCheck instanceof VIPCustomerReview){ 
        VIPCustomerReview namecheck = (VIPCustomerReview) customerNameCheck;
